...
export const dataProvider = ({ firebaseConfig, firebaseApp, firestore, firestoreFuncs: ff }) => {
  console.log({firebaseConfig, firebaseApp, firestore, ff})
  ...
  return ({
    ...
    getMany:    (resource, params) => {
      ...
      return getDocs(query(collection(firestore, resource), where(targetField, "in", ids)))
      .then(getResults)
